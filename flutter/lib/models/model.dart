...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsXlDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsXlDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsXlDeskVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get XlDeskVirtualDisplays => List<int>.from(
        platformAdditions[kPlatformAdditionsXlDeskVirtualDisplays] ?? []);
  ...
  bool get isXlDeskIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'xldesk_idd';
